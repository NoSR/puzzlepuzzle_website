      ...
      <section className={styles.themesSection}>
        ...
        <div className={styles.themeGrid}>
          {featuredThemes.map((theme, i) => (
            <FadeIn key={theme.id} delay={i * 120}>
      ...
      <section className={styles.whySection}>
        <div className={styles.whyInner}>
          ...
          <div className={styles.whyVisual}>
            {[
              { icon: '🎭', title: '몰입형 스토리', desc: '단순한 퍼즐이 아닌, 진짜 이야기 속으로 들어가는 경험.' },
              { icon: '🔐', title: '혁신적 잠금장치', desc: '디지털과 아날로그를 결합한 창의적 퍼즐 시스템.' },
              { icon: '🎵', title: '라이브 사운드', desc: '전문 사운드 디자이너가 설계한 몰입형 사운드스케이프.' },
            ].map((item, i) => (
